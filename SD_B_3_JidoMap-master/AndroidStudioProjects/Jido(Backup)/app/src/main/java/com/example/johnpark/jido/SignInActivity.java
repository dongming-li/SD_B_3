                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                           ...
                           // boolean success = jsonResponse.getBoolean("success");
                            System.out.print("came here at least");
                            AlertDialog.Builder builder = new AlertDialog.Builder(SignInActivity.this);
                            builder.setMessage("came here at least").setNegativeButton("Retry", null).create().show();

                            if(true){
                                String name = jsonResponse.getString("name");
                                 builder = new AlertDialog.Builder(SignInActivity.this);
                                builder.setMessage(name).setNegativeButton("Retry", null).create().show();
